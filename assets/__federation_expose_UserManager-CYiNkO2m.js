...
import { E as EditIcon, D as DeleteIcon } from './Edit-CR6BYPa_.js';
import { u as useTheme, I as IconButton, S as Snackbar, A as Alert } from './Snackbar-Dvm1Ivsw.js';
...
'hostApp':{url:'http://localhost:3006/assets/remoteEntry.js',format:'esm',from:'vite'}
                ...
                const wrapShareModule = remoteFrom => {
                  return merge$1({
                    'react':{'undefined':{get:()=>get(new URL('__federation_shared_react-Bfaz99l3.js', import.meta.url).href), loaded:1}},'react-dom':{'undefined':{get:()=>get(new URL('__federation_shared_react-dom-C8HiEUq4.js', import.meta.url).href), loaded:1}},'@mui/material':{'undefined':{get:()=>get(new URL('__federation_shared_@mui/material-CVD1Eozl.js', import.meta.url).href), loaded:1}},'@mui/icons-material':{'undefined':{get:()=>get(new URL('__federation_shared_@mui/icons-material-Y7lUY6gD.js', import.meta.url).href), loaded:1}},'@emotion/react':{'undefined':{get:()=>get(new URL('__federation_shared_@emotion/react-CwxzbsHR.js', import.meta.url).href), loaded:1}},'@emotion/styled':{'undefined':{get:()=>get(new URL('__federation_shared_@emotion/styled-DXgepBBw.js', import.meta.url).href), loaded:1}},'ag-grid-enterprise':{'undefined':{get:()=>get(new URL('__federation_shared_ag-grid-enterprise-B96SN8D8.js', import.meta.url).href), loaded:1}},'ag-grid-community':{'undefined':{get:()=>get(new URL('__federation_shared_ag-grid-community-CQePhgqq.js', import.meta.url).href), loaded:1}},'ag-grid-react':{'undefined':{get:()=>get(new URL('__federation_shared_ag-grid-react-BvitBkHL.js', import.meta.url).href), loaded:1}},'react-redux':{'undefined':{get:()=>get(new URL('__federation_shared_react-redux-CMbQ4p52.js', import.meta.url).href), loaded:1}},'@reduxjs/toolkit':{'undefined':{get:()=>get(new URL('__federation_shared_@reduxjs/toolkit-BH5nSKfy.js', import.meta.url).href), loaded:1}}
  ...
  try {
    ...
    if (filterModel) {
      Object.keys(filterModel).forEach((key) => {
        ...
        if (filter.filter !== void 0 && filter.filter !== null) {
...
const ActionsRenderer = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { onClick: handleEdit, size: "small", sx: { color: theme.palette.primary.main }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(EditIcon, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { onClick: handleDelete, size: "small", sx: { color: theme.palette.error.main }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DeleteIcon, {}) })
  ] });
};

const {LicenseManager} = await importShared('ag-grid-enterprise');
const {useCallback: useCallback$1,useMemo: useMemo$1,useRef: useRef$2} = await importShared('react');

const {AgGridReact} = await importShared('ag-grid-react');

const {ModuleRegistry,NumberFilterModule,TextFilterModule,ValidationModule} = await importShared('ag-grid-community');

const {RowGroupingModule,ServerSideRowModelModule,ServerSideRowModelApiModule} = await importShared('ag-grid-enterprise');
...
const UserDataGrid = ({ onEditHandler, onDeleteHandler, gridRef, gridKey }) => {
  const gridContainerRef = useRef$2(null);
  const gridStyle = useMemo$1(() => ({
    height: "500px",
    width: "100%",
    overflowX: "auto"
  }), []);
  const rowSelection = "multiple";
  const columnDefs = useMemo$1(
    () => [
      {
        headerName: "Actions",
  ...
  const createServerSideDatasource = useCallback$1(() => {
    return {
  ...
  const onGridReady = useCallback$1((params) => {
    if (gridRef.current) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: gridStyle, ref: gridContainerRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    AgGridReact,
    {
      columnDefs,
      defaultColDef,
...
const {createContext,useContext,Children,useRef: useRef$1,useEffect,useState: useState$1,useCallback,useMemo,useImperativeHandle,createElement,useLayoutEffect,forwardRef,Component} = await importShared('react');
function _extends() {
...
function useFormik(_ref) {
  ...
  var initialValues = useRef$1(props.initialValues);
  var initialErrors = useRef$1(props.initialErrors || emptyErrors);
  var initialTouched = useRef$1(props.initialTouched || emptyTouched);
  var initialStatus = useRef$1(props.initialStatus);
  var isMounted = useRef$1(false);
  var fieldRegistry = useRef$1({});
  useEffect(function() {
  ...
  var _React$useState = useState$1(0), setIteration = _React$useState[1];
  var stateRef = useRef$1({
...
const {Dialog: Dialog$1,DialogTitle: DialogTitle$1,DialogContent: DialogContent$1,DialogActions: DialogActions$1,Button: Button$2,TextField} = await importShared('@mui/material');
const EditUserSchema = create$3().shape({
  name: create$6().required("Name is required"),
  age: create$5().typeError("Age must be a number").required("Age is required").min(1, "Age must be greater than 0"),
  city: create$6().required("City is required"),
  country: create$6().required("Country is required")
});
const EditUserDialog = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog$1, { open, onClose, maxWidth: "sm", fullWidth: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle$1, { children: action === "add" ? "Add User" : "Edit User" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Formik,
      {
        ...
        children: ({
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "hidden", name: "id", value: values.id || "" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TextField,
            {
              ...
              helperText: touched.name && typeof errors.name === "string" ? errors.name : void 0
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TextField,
            {
              ...
              helperText: touched.age && typeof errors.age === "string" ? errors.age : void 0
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TextField,
            {
              ...
              helperText: touched.city && typeof errors.city === "string" ? errors.city : void 0
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TextField,
            {
              ...
              helperText: touched.country && typeof errors.country === "string" ? errors.country : void 0
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogActions$1, { sx: { mt: 2, p: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button$2, { onClick: onClose, color: "secondary", children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button$2, { type: "submit", color: "primary", disabled: isSubmitting, children: action === "add" ? "Add" : "Save" })
          ] })
        ] })
      }
    ) })
...
const {Dialog,DialogTitle,DialogContent,DialogActions,Button: Button$1,Typography: Typography$1} = await importShared('@mui/material');
...
const DeleteUserDialog = ({ open, userName, onClose, onConfirm }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onClose, maxWidth: "xs", fullWidth: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Confirm Deletion" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography$1, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogActions, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { onClick: onConfirm, color: "error", children: "Delete" })
    ] })
  ] });
};

const AlertManager = ({ message, type, open, onClose }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Snackbar, { open, autoHideDuration: 6e3, onClose, anchorOrigin: { vertical: "top", horizontal: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { onClose, severity: type, sx: { width: "100%" }, children: message }) });
};

const {useRef,useState} = await importShared('react');

const {Typography,Button,Box,Card,CardContent,Stack} = await importShared('@mui/material');
const {useDispatch} = await importShared('react-redux');

const __federation_var_hostAppErrorHandler = await __federation_method_getRemote("hostApp" , "./ErrorHandler");
 let {setError} = __federation_var_hostAppErrorHandler;
const UserManager = () => {
  const [deletingUser, setDeletingUser] = useState(null);
  const [isDialogOpen, setIsDialogOpen] = useState({ action: null, user: null });
  const [isOpenDelete, setIsOpenDelete] = useState(false);
  const [gridKey, setGridKey] = useState("");
  const [alert, setAlert] = useState({ message: "", type: ALERT_TYPE.INFO });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { variant: "outlined", sx: { width: "100%" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertManager, { message: alert.message, type: alert.type, open, onClose: () => setOpen(false) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h4", gutterBottom: true, children: USERS_LABELS.USER_LIST }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "contained", color: "primary", onClick: () => setIsDialogOpen({ action: "add", user: null }), children: "Add User" })
      ] }),
